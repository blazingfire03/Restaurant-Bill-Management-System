...
def main():
    ...
    g.Decaf_coffee_Entry.insert("end", "0")
    ...
    g.Chicken_Biryani_Entry.insert("end", "0")
    g.Chola_Kulcha_Entry.insert("end", "0")
    g.Masala_Dosa_Entry.insert("end", "0")
    g.Upma_Entry.insert("end", "0")
    ...
    g.Upma_Entry.config(state="disabled")
    g.Masala_Dosa_Entry.config(state="disabled")
    g.Chola_Kulcha_Entry.config(state="disabled")
    g.Chicken_Biryani_Entry.config(state="disabled")
    ...
    g.Decaf_coffee_Entry.config(state="disabled")
...
def reset():
    ...
    if m == 1:
        ...
        g.Decaf_coffee_Entry.delete(0, 5)
        ...
        g.Chicken_Biryani_Entry.delete(0, 5)
        g.Chola_Kulcha_Entry.delete(0, 5)
        g.Masala_Dosa_Entry.delete(0, 5)
        g.Upma_Entry.delete(0, 5)
...
def total():
    ...
    v = int(g.Decaf_coffee_Entry.get())
    ...
    k = int(g.Chicken_Biryani_Entry.get())
    ck = int(g.Chola_Kulcha_Entry.get())
    q = int(g.Masala_Dosa_Entry.get())
    p = int(g.Upma_Entry.get())

    Latte, Espresso, Iced_latte, Decaf_coffee, Cappucino = 150, 125, 200, 170, 145
    Frappé, Doppio, Iced_cap, Mojito = 289, 215, 299, 129
    Cheese, Red, Pasta, lasagna, Carnitas = 215, 289, 599, 649, 430
    Chicken_Biryani, Chola_Kulcha, Masala_Dosa, Upma = 229, 559, 410, 300
...
def recipt():
    ...
    if g.var4.get() == 1: g.listbox.insert("end", "     Decaf Coffee                          {}                                            {}".format(g.Decaf_coffee_Entry.get(), total_tuple[8]))
    ...
    if g.var15.get() == 1: g.listbox.insert("end", "     Chicken Biryani                                  {}                                          {}".format(g.Chicken_Biryani_Entry.get(), total_tuple[19]))
    if g.var16.get() == 1: g.listbox.insert("end", "     Chola Kulcha                    {}                                          {}".format(g.Chola_Kulcha_Entry.get(), total_tuple[20]))
    if g.var17.get() == 1: g.listbox.insert("end", "     Masala Dosa                   {}                                          {}".format(g.Masala_Dosa_Entry.get(), total_tuple[21]))
    if g.var18.get() == 1: g.listbox.insert("end", "     Upma Sandwich                            {}                                          {}".format(g.Upma_Entry.get(), total_tuple[22]))
...
def Decaf_coffee():
    if g.var4.get() == 1:
        g.Decaf_coffee_Entry.config(state="normal")
        g.Decaf_coffee_Entry.delete(0, 5)
    else:
        g.Decaf_coffee_Entry.delete(0, 5)
        g.Decaf_coffee_Entry.insert("end", "0")
...
def Chicken_Biryani():
    if g.var15.get() == 1:
        g.Chicken_Biryani_Entry.config(state="normal")
        g.Chicken_Biryani_Entry.delete(0, 5)
    else:
        g.Chicken_Biryani_Entry.delete(0, 5)
        g.Chicken_Biryani_Entry.insert("end", "0")
...
def Chola_Kulcha ():
    if g.var16.get() == 1:
        g.Chola_Kulcha_Entry.config(state="normal")
        g.Chola_Kulcha_Entry.delete(0, 5)
    else:
        g.Chola_Kulcha_Entry.delete(0, 5)
        g.Chola_Kulcha_Entry.insert("end", "0")
...
def Masala_Dosa():
    if g.var17.get() == 1:
        g.Masala_Dosa_Entry.config(state="normal")
        g.Masala_Dosa_Entry.delete(0, 5)
    else:
        g.Masala_Dosa_Entry.delete(0, 5)
        g.Masala_Dosa_Entry.insert("end", "0")
...
def Upma():
    if g.var18.get() == 1:
        g.Upma_Entry.config(state="normal")
        g.Upma_Entry.delete(0, 5)
    else:
        g.Upma_Entry.delete(0, 5)
        g.Upma_Entry.insert("end", "0")
